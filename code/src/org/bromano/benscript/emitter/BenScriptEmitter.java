...
public class BenScriptEmitter implements Emitter {
    ...
    private void emitVariableDeclarationStatement(VariableDeclarationStatement statement) throws EmitterException {
    ...
    private void emitStatement(Statement statement) throws EmitterException {
        ...
        if (statement instanceof BreakStatement) {
            ...
            this.emitCompoundStatement((CompoundStatement)statement);
            ...
            this.emitFunctionDeclarationStatement((FunctionDeclarationStatement)statement);
            ...
            this.emitVariableDeclarationStatement((VariableDeclarationStatement) statement);
    ...
    private void emitBooleanLiteralExpression(BooleanLiteralExpression expression) {
    ...
    private void emitPostfixExpression(PostfixExpression expression) throws EmitterException {
    ...
    private void emitExpression(Expression expression) throws EmitterException {
        ...
        if (expression instanceof PropertyAccessorExpression) {
            ...
            this.emitBooleanLiteralExpression((BooleanLiteralExpression) expression);
            ...
            this.emitPostfixExpression((PostfixExpression) expression);
